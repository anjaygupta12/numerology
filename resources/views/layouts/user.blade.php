...
<body>
        ...
        <div class="container">
            ...
            <div class="user-info">
                ...
                <div class="user-dropdown">
                    <span>{{ Auth::user()->name }} <i class="fas fa-chevron-down ms-2"></i></span>
                    <div class="user-dropdown-menu">
                        <a href="{{ route('user.dashboard') }}" class="user-dropdown-item">
                            <i class="fas fa-tachometer-alt"></i> Dashboard
                        </a>
                        <a href="{{ route('user.orders.index') }}" class="user-dropdown-item">
    ...
    <div class="container mt-3">
        <div class="horizontal-menu">
            ...
            <div class="horizontal-menu-items">
                <a href="{{ route('user.dashboard') }}" class="horizontal-menu-item {{ request()->routeIs('user.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
                <a href="{{ route('user.orders.index') }}" class="horizontal-menu-item {{ request()->routeIs('user.orders.*') ? 'active' : '' }}">
                    <i class="fas fa-shopping-bag"></i> My Orders
                </a>
                <a href="{{ route('user.numerology.name') }}" class="horizontal-menu-item {{ request()->routeIs('user.numerology.name') ? 'active' : '' }}">
                    <i class="fas fa-signature"></i> Name Numerology
                </a>
                <a href="{{ route('user.numerology.numapp') }}" class="horizontal-menu-item {{ request()->routeIs('user.numerology.numapp') ? 'active' : '' }}">
                    <i class="fas fa-mobile-alt"></i> Numerology Application
                </a>
                <a href="{{ route('user.numerology.mobile') }}" class="horizontal-menu-item {{ request()->routeIs('user.numerology.mobile') ? 'active' : '' }}">
                    <i class="fas fa-mobile-alt"></i> Mobile Numerology
                </a>
                <a href="{{ route('user.numerology.birth') }}" class="horizontal-menu-item {{ request()->routeIs('user.numerology.birth') ? 'active' : '' }}">
    ...
    <footer class="user-footer">
        <div class="container">
            <p>&copy; {{ date('Y') }} SRK Numerology. All Rights Reserved.</p>
        </div>
    </footer>
