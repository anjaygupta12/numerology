        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.attributes.update', $attribute) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('compound_number') is-invalid @enderror" id="compound_number" name="compound_number" value="{{ old('compound_number', $attribute->compound_number) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control summernote @error('description') is-invalid @enderror" id="description" name="description" required>{{ old('description', $attribute->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
