...
@section('title', 'Ad Yoda Prediction')
@section('page-title', 'Ad Yoda Prediction')

@section('content')
    <div class="card dashboard-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Ad Yoda Predictiona</h5>
            <a href="{{ route('admin.ad-yoga-prediction.create') }}" class="btn btn-primary">Add New Combination</a>
        </div>
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.ad-yoga-prediction.edit', $attribute) }}" class="btn btn-sm btn-primary">Edit</a>
                                            <form action="{{ route('admin.ad-yoga-prediction.destroy', $attribute) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this Combination?');">
                                                @csrf @method('DELETE')
