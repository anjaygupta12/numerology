...
@section('title', 'Edit Remedy')

@section('page-title', 'Edit Remedy')
...
@section('content')
    <div class="card dashboard-card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.remedies.update', $remedy) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="number" id="number" class="form-control @error('number') is-invalid @enderror" value="{{ old('number', $remedy->number) }}" min="1" max="9" required>
                            @error('number')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="status" name="status" value="1" {{ old('status', $remedy->status) ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control summernote @error('bn') is-invalid @enderror" id="bn" name="bn">{{ old('bn', $remedy->bn) }}</textarea>
                    @error('bn')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control summernote @error('dn') is-invalid @enderror" id="dn" name="dn">{{ old('dn', $remedy->dn) }}</textarea>
                    @error('dn')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control summernote @error('nn') is-invalid @enderror" id="nn" name="nn">{{ old('nn', $remedy->nn) }}</textarea>
                    @error('nn')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
