...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        {{-- ══ CALCULATE FORM (completely unchanged) ══ --}}
        <form action="{{ route('user.numerology.name.calculate') }}" method="POST">
            @csrf
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                        ...
                        value="{{ old('first_name', $result['first_name'] ?? '') }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control @error('middle_name') is-invalid @enderror"
                        ...
                        value="{{ old('middle_name', $result['middle_name'] ?? '') }}">
        ...
        {{-- ── server-side PDF (original, unchanged) ── --}}
        {{-- <form action="{{ route('user.generate.pdf') }}" method="POST" target="_blank" class="no-print mb-2">
            @csrf
            <input type="hidden" name="data" value='@json($result)'>
            <button type="submit" class="btn btn-primary">Generate PDF</button>
        </form> --}}

        {{-- ── JS PDF download button ── --}}
        ...
        <div class="mt-2">
            <div class="card result-card">
                <div class="card-header text-dark">
                    <h5 class="mb-0">Results for: {{ $result['full_name'] }}</h5>
                </div>
                <div class="card-body">

                    {{-- ════════════════════════════════
                         MODULE 1 — Numerology Chart
                    ════════════════════════════════ --}}
                                ...
                                <td colspan="3" style="padding:0;">
                                    <table class="main-table" border="0" width="100%">
                                            ...
                                            <td>
                                                <table border="0" cellspacing="0" cellpadding="0"><tr>
                                                    ...
                                                    <td class="additional-info">
                                                        @if(isset($yog_labels['fn']) && count($yog_labels['fn'])){{ implode(', ',$yog_labels['fn']) }}@endif
                                                    </td>
                                                </tr></table>
                                            </td>
                                            <td rowspan="7" style="vertical-align:top;padding:10px;">
                                                <div style="display:flex;flex-direction:column;">
                                                    ...
                                                    <div style="display:flex;margin-top:15px;">
                                                        ...
                                                        <div class="result-value" style="width:100px;">{{ $result['zodiacNum'] }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="input-cell"><div class="input-field">{{ $result['middle_name'] }}</div></td>
                                            <td><table border="0" cellspacing="0" cellpadding="0"><tr>
                                                ...
                                                <td class="additional-info">
                                                    @if(isset($yog_labels['nn']) && count($yog_labels['nn'])){{ implode(', ',$yog_labels['nn']) }}@endif
                                                </td>
                                            </tr></table></td>
                                        </tr>
                                        <tr>
                                            <td class="label-cell">Last Name:</td>
                                            <td class="input-cell"><div class="input-field">{{ $result['last_name'] }}</div></td>
                                            <td><table border="0" cellspacing="0" cellpadding="0"><tr>
                                                <td class="result-text"></td>
                                                <td><div class="result-box-container">
                                                ...
                                                <td class="additional-info">
                                                    @if(isset($yog_labels['in']) && count($yog_labels['in'])){{ implode(', ',$yog_labels['in']) }}@endif
                                                </td>
                                            </tr></table></td>
                                        </tr>
                                        <tr>
                                            <td class="label-cell">Birth Date :</td>
                                            <td class="input-cell"><div class="input-field">{{ date('d-m-Y',strtotime($result['birth_date'])) }}</div></td>
                                            <td><table border="0" cellspacing="0" cellpadding="0"><tr>
                                                <td class="result-text"></td>
                                                <td><div class="result-box-container">
                                                ...
                                                <td class="additional-info">
                                                    @if(isset($yog_labels['en']) && count($yog_labels['en'])){{ implode(', ',$yog_labels['en']) }}@endif
                                                </td>
                                            </tr></table></td>
                                        </tr>
                                        <tr>
                                            <td class="label-cell">First Letter :</td>
                                            <td class="input-cell"><div class="input-field cream-bg">{{ $result['first_name'][0] }}</div></td>
                                            <td><table border="0" cellspacing="0" cellpadding="0"><tr>
                                                <td class="result-text"></td>
                                                <td><div class="result-box-container">
                                                ...
                                                <td class="additional-info">
                                                    @if(isset($yog_labels['pn']) && count($yog_labels['pn'])){{ implode(', ',$yog_labels['pn']) }}@endif
                                                </td>
                                            </tr></table></td>
                                        </tr>
                                        <tr>
                                            <td class="label-cell">DOB - BN :</td>
                                            <td class="input-cell"><div class="input-field cream-bg">{{ $result['bn_single'] }}</div></td>
                                            <td><table border="0" cellspacing="0" cellpadding="0"><tr>
                                                <td class="result-text"></td>
                                                <td><div class="result-box-container">
                                        ...
                                        <tr>
                                            ...
                                            <td class="input-cell"><div class="input-field cream-bg">{{ $result['dn_single'] }}</div></td>
                                            <td colspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="input-cell"><div class="input-field cream-bg">{{ $result['bs'] }}</div></td>
                                            <td colspan="2"></td>
                                        </tr>
                                        <tr>
                                            <td class="label-cell">DOB - WN :</td>
                                            <td class="input-cell"><div class="input-field cream-bg">{{ $result['wn'] }}</div></td>
                                            <td colspan="2"></td>
                                        </tr>
                                        <tr>
                                            <td class="label-cell">DOB - OP :</td>
                                            <td class="input-cell"><div class="input-field cream-bg">{{ $result['op'] }}</div></td>
                                            <td colspan="2"></td>
                                        </tr>
                                    </table>
                                </td>
...
@endphp
                    ...
                    {{-- ════════════════════════════════
                         MODULE 2 — Sounds / Gridding / Pyramids
                    ════════════════════════════════ --}}
                    <div class="module-heading-row no-print">
                    ...
                    <div class="pdf-module-section" id="mod_sounds">
                        <table class="main-table">
                            <tr><td colspan="4">Good Sounds : {{ implode(', ',$result['good_sounds']) }}</td></tr>
                            <tr><td colspan="4">Bad Sounds : {{ implode(', ',$result['bad_sounds']) }}</td></tr>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    @foreach($firstNameLetters as $index => $letter)
                                                        @if($index==0)<td class="number-box"></td>
                                                        @else<td class="number-box">{{ $counter }}</td>@php $counter++; if($counter>9)$counter=1; @endphp
                                                        @endif
                                                    @endforeach
                                                    @for($i=count($firstNameLetters);$i<12;$i++)<td class="number-box"></td>@endfor
                                                </tr>
                                                <tr>
                                                    @php  $counterSec = 0;  $letterValues=['A'=>1,'B'=>2,'C'=>3,'D'=>4,'E'=>5,'F'=>6,'G'=>3,'H'=>5,'I'=>1,'J'=>1,'K'=>2,'L'=>3,'M'=>4,'N'=>5,'O'=>7,'P'=>8,'Q'=>1,'R'=>2,'S'=>3,'T'=>4,'U'=>6,'V'=>6,'W'=>6,'X'=>5,'Y'=>1,'Z'=>7]; @endphp
                                                    @foreach($firstNameLetters as $letter)
                                                        <td class="letter-box"
                                                            @if(checkPairExists($counterSec . '/' . $letterValues[$letter])) style="background-color:pink" @endif>
                                                            {{ $letter }}</td>
                                                            @php $counterSec++; if($counterSec>9)$counterSec=1; @endphp
                                                    @endforeach
                                                    @for($i=count($firstNameLetters);$i<12;$i++)<td class="letter-box"></td>@endfor
                                                </tr>
                                                <tr>
                                                    @foreach($firstNameLetters as $letter)
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    @foreach($middleNameLetters as $letter)
                                                        ...
                                                        @php $middleCounter++; if($middleCounter>9)$middleCounter=1; @endphp
                                                    @endforeach
                                                    @for($i=count($middleNameLetters);$i<12;$i++)<td class="number-box"></td>@endfor
                                                </tr>
                                                <tr>
                                                    @foreach($middleNameLetters as $letter)
                                                        <td class="letter-box"
                                                            @if(checkPairExists($middleCounter2 . '/' . $letterValues[$letter])) style="background-color:pink" @endif>
                                                            {{ $letter }}</td>
                                                             @php $middleCounter2++; if($middleCounter2>9)$middleCounter2=1; @endphp
                                                    @endforeach
                                                    @for($i=count($middleNameLetters);$i<12;$i++)<td class="letter-box"></td>@endfor
                                                </tr>
                                                <tr>
                                                    @foreach($middleNameLetters as $letter)
                                                        <td class="number-box">{{ $letterValues[$letter]??'' }}</td>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    @foreach($lastNameLetters as $letter)
                                                        ...
                                                        @php $lastCounter++; if($lastCounter>9)$lastCounter=1; @endphp
                                                    @endforeach
                                                    @for($i=count($lastNameLetters);$i<12;$i++)<td class="number-box"></td>@endfor
                                                </tr>
                                                <tr>
                                                    @foreach($lastNameLetters as $letter)<td class="letter-box"
                                                    @if(checkPairExists($lastCounter2 . '/' . $letterValues[$letter])) style="background-color:pink" @endif>
                                                    {{ $letter }}</td>@endforeach
                                                    @for($i=count($lastNameLetters);$i<12;$i++)<td class="letter-box"></td>
                                                     @php $lastCounter2++; if($lastCounter2>9)$lastCounter2=1; @endphp
                                                     @endfor
                                                </tr>
                                                <tr>
                                                    @foreach($lastNameLetters as $letter)
                                        ...
                                        <tr>
                                            ...
                                            <td width="25%">
                                                <table class="pyramid-container">
                                                    ...
                                                    <tr><td>
                                                        <div class="pyramid">
                                                            <div class="pyramid-top"><span>{{ $result['pyramid_numbers'][0] }}</span><div class="pyramid-top-label">P1</div></div>
                                            ...
                                            <td width="25%">
                                                <table class="pyramid-container">
                                                    ...
                                                    <tr><td>
                                                        <div class="pyramid">
                                                            <div class="pyramid-top"><span>{{ $result['pyramid_numbers'][1] }}</span><div class="pyramid-top-label">P2</div></div>
                                                            <div class="pyramid-bottom">
                                                                <div class="pyramid-bottom-box">{{ $result['bn_single'] }}</div>
                                                                <div class="pyramid-bottom-box">{{ $result['dn_single'] }}</div>
                                                            </div>
                                            ...
                                            <td width="25%">
                                                <table class="pyramid-container">
                                                    ...
                                                    <tr><td>
                                                        <div class="pyramid">
                                                            <div class="pyramid-top"><span>{{ $result['pyramid_numbers'][2] }}</span><div class="pyramid-top-label">P3</div></div>
                                                            <div class="pyramid-bottom">
                                                                <div class="pyramid-bottom-box">{{ $result['bn_single'] }}</div>
                                                                <div class="pyramid-bottom-box">{{ $result['dn_single'] }}</div>
                                                            </div>
                            ...
                            <tr>
                                ...
                                <td class="description-col">
                                    <div contenteditable>
                                        ...
                                        @else
                                            <em>No specific attributes available for letter "{{ $result['first_letter'] }}".</em>
                                        @endif
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div class="pdf-module-section" id="mod_rem">
                        <table class="remedies-table remedies_tbl">
                            ...
                            <tr class="content-row">
                                <td class="content-cell number-cell">{{ $cnt++ }}</td>
                                ...
                                <div class="yantra">
                                    ...
                                    <table class="grid-table" border="1">
                                        @foreach($result['birthdate_energiser'] as $row)
                                            @if($loop->last)
                                                <tr><td><b>{{ $row[0] }}</b></td><td><b>{{ $row[1] }}</b></td><td><b>{{ $row[2] }}</b></td><td><b>{{ $row[3] }}</b></td><td><b>{{ $row[4] }}</b></td></tr>
                                            @else
                                                <tr><td>{{ $row[0] }}</td><td>{{ $row[1] }}</td><td>{{ $row[2] }}</td><td>{{ $row[3] }}</td><td><b>{{ $row[4] }}</b></td></tr>
                                            @endif
                                        @endforeach
                                    </table>
                    ...
                    <div class="pdf-module-section" id="mod_fy">
                        <table class="remedies-table remedies_tbl">
                            ...
                            @if($result['fyPre'])
                            <tr class="content-row">
                                <td class="content-cell number-cell">{{ $result['fynum'] }}</td>
                                <td class="content-cell birth-node" colspan="4">{{ $result['fyPre']['name'] }}</td>
                                <td class="content-cell" colspan="4">
                                    <ul style="margin:0;padding-left:15px;">
                                        <li><strong>
                                            <input style="border-style:none;" type="text" name="fy_title[]"
                                                value="{{ $result['fyPre']['title'] }}" class="form-control">
                                        </strong></li>
                                        <textarea style="border-style:none" name="fy_description[]"
                                            class="form-control" rows="2">{{ $result['fyPre']['description'] }}</textarea>
                                    </ul>
                                </td>
                            </tr>
                            @endif
                    ...
                    <div class="pdf-module-section" id="mod_rage">
                        <table class="remedies-table remedies_tbl">
                            ...
                            <tr class="content-row">
                                ...
                                <td class="content-cell birth-node" colspan="4">{{ $result['running_age'] }}</td>
                                <td class="content-cell" colspan="4">
                                    Running Age
                                </td>
                            </tr>
