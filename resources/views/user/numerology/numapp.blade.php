...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <form action="{{ route('user.numerology.numapp.calculate') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label for="first_name" class="form-label">First Name</label>
                        <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="first_name"
                            name="first_name" value="{{ old('first_name', $result['first_name'] ?? '') }}" required>
                        @error('first_name')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('last_name') is-invalid @enderror" id="last_name"
                            name="last_name" value="{{ old('last_name', $result['last_name'] ?? '') }}">
                        @error('last_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
               ...
               <!-- In your blade view -->
                <form action="{{ route('user.numerology.download.pdf') }}" method="GET" class="d-inline">
                    <input type="hidden" name="numerology_data" value="{{ json_encode($result) }}">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table class="attributes_tbl">
                                                        <tr>
                                                            <td class="attribute-col">D.O.B - BN <br> ({{ $result['bn'] }})</td>
                                                            <td class="description-col"><div contenteditable>{!! $result['attrs'][$result['bn']] !!}</div></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="attribute-col">D.O.B - DN <br> ({{ $result['dn'] }})</td>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table class="table table-bordered border-dark text-center">
                                                        ...
                                                        <tr>
                                                            <td>{{ $dob_chart[0][0] ? $dob_chart[0][0] : '0' }}</td>
                                                            <td>{{ $dob_chart[0][1] ? $dob_chart[0][1] : '0' }}</td>
                                                            <td>{{ $dob_chart[0][2] ? $dob_chart[0][2] : '0' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>{{ $dob_chart[1][0] ? $dob_chart[1][0] : '0' }}</td>
                                                            <td>{{ $dob_chart[1][1] ? $dob_chart[1][1] : '0' }}</td>
                                                            <td>{{ $dob_chart[1][2] ? $dob_chart[1][2] : '0' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>{{ $dob_chart[2][0] ? $dob_chart[2][0] : '0' }}</td>
                                                            <td>{{ $dob_chart[2][1] ? $dob_chart[2][1] : '0' }}</td>
                                                            <td>{{ $dob_chart[2][2] ? $dob_chart[2][2] : '0' }}</td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    {{-- <h4 class="mt-5">DOB Yogas Combinations</h4> --}}
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <table class="table table-bordered table-hover">
                                                                <tbody>
                                                           @foreach ($result['yoga_com_preduction'] as $comb => $val)
                                                                    <tr>
                                                                        <th style="width:25%;">{{ $comb }}</th>
                                                                        <td>{!! $val !!}</td>
                                                                    </tr>
                                                                    @endforeach
                                        ...
                                        <div class="tab-pane fade" id="v-pills-md-yogas" role="tabpanel" aria-labelledby="v-pills-md-yogas-tab">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul>
                                                        @foreach ($result['md_yoga_com_preduction'] as $preduction=>$val)
                                                        <li>
                                                          <strong>{{ $preduction }} Yoga:</strong>
                                                          <ul>
                                                           {!! $val !!}
                                                          </ul>
                                                        </li>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-ad-yogas" role="tabpanel" aria-labelledby="v-pills-ad-yogas-tab">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul>
                                                          @foreach ($result['ad_preduction'] as $preduction=>$val)
                                                        <li>
                                                          <strong>{{ $preduction }} AD :</strong>
                                                          <ul>
                                                           {!! $val !!}
                                                          </ul>
                                                        </li>
                                                    ...
                                                    <ul>
                                                          @foreach ($result['ad_yoga_com_preduction'] as $preduction=>$val)
                                                        <li>
                                                          <strong>{{ $preduction }} Yoga :</strong>
                                                          <ul>
                                                           {!! $val !!}
                                                    ...
                                                    <div class="alert alert-primary">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%">{{ $result['pd_chart']['to_date'] }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td width="80%">Dasha</td>
                                                                <td width="20%">{{ $result['pd_chart']['dasha'] }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td width="80%">Antardasha</td>
                                                                <td width="20%">{{ $result['pd_chart']['antardasha'] }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td width="80%">Pratyantardasha</td>
                                                                <td width="20%">{{ $result['pd_chart']['pratyantardasha'] }}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>{{ $result['chars']['colors']??null }}</th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        {{-- <tr>
                                                            <th><strong>Lucky Sumbon</strong></th>
                                                            <th>3</th>
                                                        </tr> --}}
                                                    </table>
