...
<body>
    ...
    <main>
        @if (isset($result))
                                ...
                                <td rowspan="7" style="vertical-align: top; padding: 10px;">
                                    <div style="display: flex; flex-direction: column;">
                                        <table class="natal-grid" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            @foreach ($result['vedic_chart_array'] as $row)
                                                <tr>
                                                    @foreach ($row as $cell)
                            ...
                            <tr>
                                ...
                                <td class="input-cell">
                                    <div class="input-field">
                                        {{ date('d-m-Y', strtotime($result['birth_date'])) }}</div>
                                </td>
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
            ...
            <table class="main-table">
                <tr>
                    <td colspan="4">Good Sounds : {{ implode(', ', $result['good_sounds']) }}</td>
                </tr>
                <tr>
                    <td colspan="4">Bad Sounds : {{ implode(', ', $result['bad_sounds']) }}</td>
                </tr>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($firstNameLetters as $letter)
                                                <td class="letter-box"
                                                    @if (in_array($letterValues[$letter] ?? null, $result['enemy_number_first_name'])) style="background-color: pink" @endif>
                                                    {{ $letter }}</td>
                                            @endforeach
                                            @for ($i = count($firstNameLetters); $i < 12; $i++)
                                    ...
                                    <td colspan="4" style="padding: 5px;">
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            <tr>
                                                @foreach ($middleNameLetters as $letter)
                                                    <td class="letter-box"
                                                        @if (in_array($letterValues[$letter] ?? null, $result['enemy_number_last_name'])) style="background-color: pink" @endif>
                                                        {{ $letter }}</td>
                                                @endforeach
                                                @for ($i = count($middleNameLetters); $i < 12; $i++)
                                                    <td class="letter-box"></td>
...
<tr>
            ...
            <table class="attributes_tbl">
                <tr>
                    ...
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['bn']] ?? '' !!}</div>
                    </td>
                </tr>
                <tr>
                    <td class="attribute-col">D.O.B - DN</td>
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['dn']] ?? '' !!}</div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['fn']] ?? '' !!}</div>
                    </td>
                </tr>
                <tr>
                    <td class="attribute-col">Full Name NN</td>
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['nn']] ?? '' !!}</div>
                    </td>
                </tr>
            </table>
            <div style="page-break-before: always;"></div>
             <table class="attributes_tbl" style="margin-top: 60px;">
                <tr >
                    ...
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['in']] ?? '' !!}</div>
                    </td>
                </tr>
                <tr>
                    <td class="attribute-col">Outer Nature EN</td>
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['en']] ?? '' !!}</div>
                    </td>
                </tr>
                <tr>
                    <td class="attribute-col">Core Nature PN</td>
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['pn']] ?? '' !!}</div>
                    </td>
                </tr>
                <tr>
                    <td class="attribute-col">Habbit HN</td>
                    <td class="description-col">
                        <div>{!! $result['attrs'][$result['hn']] ?? '' !!}</div>
                    </td>
                </tr>
            </table>
  <div style="page-break-before: always; margin-top: 20px;"></div>
            ...
            <table class="remedies_tbl">
                ...
                @if (!empty($result['bn_remedy']) && !empty($result['bn_remedy']['bn'] ?? $result['bn_remedy']->bn ?? null))
                    <tr class="content-row">
                        ...
                        <td class="content-cell" colspan="4">
                            {!! nl2br(e(is_array($result['bn_remedy']) ? $result['bn_remedy']['bn'] : $result['bn_remedy']->bn)) !!}
                        </td>
                    </tr>
                @endif

                @if (!empty($result['dn_remedy']) && !empty($result['dn_remedy']['dn'] ?? $result['dn_remedy']->dn ?? null))
                    <tr class="content-row">
                        <td class="content-cell number-cell">{{ $counter++ }}</td>
                        <td class="content-cell birth-node">DN: {{ $result['dn_single'] }}</td>
                        <td class="content-cell" colspan="4">
                            {!! nl2br(e(is_array($result['dn_remedy']) ? $result['dn_remedy']['dn'] : $result['dn_remedy']->dn)) !!}
                        </td>
                    </tr>
                @endif

                @if (!empty($result['nn_remedy']) && !empty($result['nn_remedy']['nn'] ?? $result['nn_remedy']->nn ?? null))
                    <tr class="content-row">
                        <td class="content-cell number-cell">{{ $counter++ }}</td>
                        <td class="content-cell birth-node">NN: {{ $result['nn_single'] }}</td>
                        <td class="content-cell" colspan="4">
                            {!! nl2br(e(is_array($result['nn_remedy']) ? $result['nn_remedy']['nn'] : $result['nn_remedy']->nn)) !!}
                        </td>
                    </tr>
                @endif
