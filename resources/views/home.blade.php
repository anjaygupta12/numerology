...
<body>
        ...
        <div class="container py-5 position-relative" style="z-index: 2;">
            <div class="row align-items-center py-5">
                <div class="col-lg-7 text-center text-lg-start text-white">
                    ...
                    <p class="lead mb-5">Unlock the secrets of numbers and their profound influence on your life journey, career path, and personal relationships.</p>
    ...
    <section class="py-5" id="packages" style="background: url('/images/home/numerology-pattern.jpg') center/cover fixed; position: relative;">
        ...
        <div class="container position-relative" style="z-index: 2;">
            <h2 class="text-center section-title mb-5">Our Numerology Packages</h2>
            ...
            @auth
                <!-- Available Packages -->
                @if(count($purchasablePackages) > 0)
                    ...
                    <div class="row g-4">
                        @foreach($purchasablePackages as $package)
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 package-card border-0 shadow">
                                    <div class="card-header text-center" style="background: var(--dark-color); color: white; border-radius: 10px 10px 0 0;">
                                        <h5 class="my-2 fw-bold">{{ $package->name }}</h5>
                                    </div>
                                    <div class="card-body d-flex flex-column p-4">
                                        <div class="text-center mb-3">
                                            <span class="badge rounded-pill" style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); padding: 8px 15px; font-size: 0.9rem;">
                                                {{ ucfirst($package->type) }} Numerology
                                            </span>
                                        </div>
                                        <p class="card-text flex-grow-1">{{ $package->description }}</p>
                                        <div class="text-center mt-4">
                                            <h3 class="card-title pricing-card-title mb-4" style="color: var(--primary-color); font-weight: 700;">₹{{ number_format($package->price, 2) }}</h3>
                                            <a href="{{ route('user.orders.create', $package) }}" class="btn btn-primary w-100 py-3">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 package-card border-0 shadow">
                                    ...
                                    <div class="card-body d-flex flex-column p-4">
                                        ...
                                        <p class="card-text flex-grow-1">{{ $package->description }}</p>
                                        <div class="text-center mt-4">
                                            <h3 class="card-title pricing-card-title mb-3" style="color: var(--primary-color); font-weight: 700;">₹{{ number_format($package->price, 2) }}</h3>
                                            ...
                                            <a href="{{ route('user.orders.index') }}" class="btn btn-outline-warning w-100 py-3">
