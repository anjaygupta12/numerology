...
<?php endif; ?>
    <div class="card dashboard-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('admin.yoga-prediction.index')); ?>" class="btn btn-secondary">Back to Combinations</a>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.yoga-prediction.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
