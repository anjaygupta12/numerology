...
<head>
    ...
    <title>SRK Numerology - <?php echo $__env->yieldContent('title', 'Admin Panel'); ?></title>
...
<body>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('admin.attributes.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.attributes.index')); ?>">
                        ...
                        Attributes
                                        ...
                                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.remedies.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.remedies.index')); ?>">
                                <i class="bi bi-heart"></i>
                                Remedies
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.first-letter-attributes.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.first-letter-attributes.index')); ?>">
                                <i class="bi bi-type"></i>
                                First Letter Attributes
                            </a>
                        </li>
                           <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.yoga-prediction.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.yoga-prediction.index')); ?>">
                                <i class="bi bi-type"></i>
                                Yoga Prediction
                            </a>
                        </li>
                            <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.md-yoga-prediction.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.md-yoga-prediction.index')); ?>">
                                <i class="bi bi-type"></i>
                                Md Yoga Prediction
                            </a>
                        </li>
                          <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.ad-yoga-prediction.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.ad-yoga-prediction.index')); ?>">
                                <i class="bi bi-type"></i>
                                Ad Yoga Prediction
                            </a>
                        </li>
                         <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.pd-yoga-prediction.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.pd-yoga-prediction.index')); ?>">
                                <i class="bi bi-type"></i>
                                PD Yoga Prediction
                            </a>
                        </li>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2"><?php echo $__env->yieldContent('page-title', 'Admin Panel'); ?></h1>
...
<?php /**PATH C:\laragon\www\numerology\resources\views/layouts/admin.blade.php ENDPATH**/ ?>