...
<?php $__env->startSection('content'); ?>
    <div class="card dashboard-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('admin.yoga-prediction.index')); ?>" class="btn btn-secondary">Back to First Letter Attributes</a>
        </div>
        <div class="card-body">
            <form action="<?php echo e(route('admin.yoga-prediction.update', $yogaPrediction)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" value=" <?php echo e(old('combination', $yogaPrediction->combination)); ?> ">
...
unset($__errorArgs, $__bag); ?>" id="description" name="description"><?php echo e(old('description', $yogaPrediction->description)); ?></textarea>
