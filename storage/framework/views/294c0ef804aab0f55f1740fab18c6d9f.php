...
<?php $__env->startSection('title', 'Create First Letter Attribute'); ?>
<?php $__env->startSection('page-title', 'Create New First Letter Attribute'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card dashboard-card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.first-letter-attributes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="letter" class="form-label">Letter</label>
                            <input type="text" name="letter" id="letter" class="form-control <?php $__errorArgs = ['letter'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('letter')); ?>" maxlength="1" required>
...
unset($__errorArgs, $__bag); ?>
                            <small class="form-text text-muted">Enter a single letter (A-Z or a-z). This letter must be unique.</small>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary">Create First Letter Attribute</button>
                </div>
            </form>
        </div>
    </div>
