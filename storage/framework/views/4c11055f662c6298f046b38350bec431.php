...
<?php $__env->startSection('content'); ?>
    <div class="card dashboard-card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.first-letter-attributes.update', $firstLetterAttribute)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('letter', $firstLetterAttribute->letter)); ?>" maxlength="1" required>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description"><?php echo e(old('description', $firstLetterAttribute->description)); ?></textarea>
