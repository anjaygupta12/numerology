<?php $__env->startSection('title', 'Edit Yogas Predictiona'); ?>
<?php $__env->startSection('page-title', 'Edit Yogas Predictiona'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card dashboard-card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.pd-yoga-prediction.update', $PdYogaPrediction)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>" value=" <?php echo e(old('combination', $PdYogaPrediction->combination)); ?> ">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                           ...
                           <select name="type" class="form-control" >
                                <option value="ad" <?php echo e($PdYogaPrediction->type == 'ad' ? 'selected' : ''); ?>>
                                    Ad prediction
                                </option>

                                <option value="cobination" <?php echo e($PdYogaPrediction->type == 'cobination' ? 'selected' : ''); ?>>
                                    Combination
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="description" name="description"><?php echo e(old('description', $PdYogaPrediction->description)); ?></textarea>
