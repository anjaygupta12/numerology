<?php $__env->startSection('title', 'Pd Yoda Prediction'); ?>
<?php $__env->startSection('page-title', 'Pd Yoda Prediction'); ?>

<?php $__env->startSection('content'); ?>
    <div class="card dashboard-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Pd Yoda Predictiona</h5>
            <a href="<?php echo e(route('admin.pd-yoga-prediction.create')); ?>" class="btn btn-primary">Add New Combination</a>
        </div>
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('admin.pd-yoga-prediction.edit', $attribute)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <form action="<?php echo e(route('admin.pd-yoga-prediction.destroy', $attribute)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this Combination?');">
