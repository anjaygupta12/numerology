...
<body>
    ...
    <script>
        ...
        // Optional: Auto resize on page load if there's already text
        document.addEventListener("DOMContentLoaded", () => {
          const textarea = document.querySelector('.form-container');
     ...
     async function downloadAsPDF() {
        ...
        try {
            ...
            const imgData = canvas.toDataURL('image/png');
             ...
             const pdf = new jsPDF('p', 'mm', 'a4', false, true);
...
<?php /**PATH /var/www/vhosts/srknumerology.com/numro.srknumerology.com/resources/views/layouts/user.blade.php ENDPATH**/ ?>