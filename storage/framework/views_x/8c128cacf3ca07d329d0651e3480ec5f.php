...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-3 text-center">
                        <p class="mb-0">
                            Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Login</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php /**PATH /var/www/vhosts/srknumerology.com/numro.srknumerology.com/resources/views/auth/register.blade.php ENDPATH**/ ?>